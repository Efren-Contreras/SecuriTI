...
<div class="container-fluid">
	<div class="card" style="padding-left: 10%; padding-right: 10%; border: 1px solid black; width: 55%; margin-left: 25%; margin-top: 2%; margin-bottom: 3%; background-image: linear-gradient(to right bottom, #5faaf2, #6db3e7, #82badb, #9bc0d1, #b5c4c9);">
		<div class="mx-auto">
			<img src="../resources/IMG/securiTI.png">
		</div>
		<div class="card-title mx-auto">
			<h1>Editar información del Servidor</h1>
		</div>
		<%
        String sql = "SELECT * FROM servers WHERE idCompany="+idCompany+" AND idServer="+idDevice;
        try {
		...
		<div class="mb-3">
			...
			<div style="display: flex;">
				<input disabled type="text" class="form-control" style="height: 2.0%;" value='<%=rs.getString("name")%>'>
				<button type="button" style="margin-left: 2%;" class="h4 btn btn-info" data-bs-toggle="modal"
					data-bs-target="#modalname">Editar</button>
			</div>
		</div>
		<div class="mb-3">
			<label for="correo" class="form-label">Tipo de Uso</label>
			<input name="iduser" type="hidden">
			<div style="display: flex;">
				<input disabled type="text" class="form-control" style="height: 2.0%;" value='<%=rs.getString("usedFor")%>'>
				<button type="button" style="margin-left: 2%;" class="h4 btn btn-info" data-bs-toggle="modal"
					data-bs-target="#modalResp">Editar</button>
			</div>
		</div>
		<div class="mb-3">
			<label for="mensaje" class="form-label">Fabricante</label>
			<div style="display: flex;">
				<input disabled type="text" class="form-control" style="height: 2.0%;" value='<%=rs.getString("manufacturer")%>'>
				<button type="button" style="margin-left: 2%;" class="h4 btn btn-info" data-bs-toggle="modal"
					data-bs-target="#modalFabricante">Editar</button>
			</div>
		</div>
		<div class="mb-3">
			<label for="mensaje" class="form-label">Modelo</label>
			<div style="display: flex;">
				<input disabled type="text" class="form-control" style="height: 2.0%;" value='<%=rs.getString("model")%>'>
				<button type="button" style="margin-left: 2%;" class="h4 btn btn-info" data-bs-toggle="modal"
					data-bs-target="#modalModelo">Editar</button>
			</div>
		</div>
		<div class="mb-3">
			<label for="mensaje" class="form-label">Serial</label>
			<div style="display: flex;">
				<input disabled type="text" class="form-control" style="height: 2.0%;" value='<%=rs.getString("serial")%>'>
				<button type="button" style="margin-left: 2%;" class="h4 btn btn-info" data-bs-toggle="modal"
					data-bs-target="#modalSerial">Editar</button>
			</div>
		</div>
		<div class="mb-3">
			<label for="mensaje" class="form-label">Sistema Operativo</label>
			<div style="display: flex;">
				<input disabled type="text" class="form-control" style="height: 2.0%;" value='<%=rs.getString("so")%>'>
				<button type="button" style="margin-left: 2%;" class="h4 btn btn-info" data-bs-toggle="modal"
					data-bs-target="#modalSO">Editar</button>
			</div>
		</div>
		<div class="mb-3">
			<label for="mensaje" class="form-label">MAC Address</label>
			<div style="display: flex;">
				<input disabled type="text" class="form-control" style="height: 2.0%;" value='<%=rs.getString("macAddress")%>'>
				<button type="button" style="margin-left: 2%;" class="h4 btn btn-info" data-bs-toggle="modal"
					data-bs-target="#modalMac">Editar</button>
			</div>
		</div>
		<div class="mb-3">
			<label for="mensaje" class="form-label">RAM</label>
			<div style="display: flex;">
				<input disabled type="number" class="form-control" style="height: 2.0%;" value='<%=rs.getString("ram")%>'>
				<button type="button" style="margin-left: 2%;" class="h4 btn btn-info" data-bs-toggle="modal"
					data-bs-target="#modalRam">Editar</button>
			</div>
		</div>
		<div class="mb-3">
			<label for="mensaje" class="form-label">Almacenamiento</label>
			<div style="display: flex;">
				<input disabled type="text" class="form-control" style="height: 2.0%;" value='<%=rs.getString("storage")%>'>
				<button type="button" style="margin-left: 2%;" class="h4 btn btn-info" data-bs-toggle="modal"
					data-bs-target="#modalAlm">Editar</button>
			</div>
		</div>
		<div class="mb-3">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- Formulario -->
					<form method="post" action="Controller/Process/editdevice.jsp?deviceType=server&formtype=name" id="myForm1">
	...
	<div class="modal fade" id="modalResp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- Formulario -->
					<form method="post" action="Controller/Process/editdevice.jsp?deviceType=server&formtype=usedFor" id="myForm1">
						<input type="hidden" id="idDevice" name="idDevice" value='<%=idDevice%>'>
						<input type="hidden" id="nameCompany" name="nameCompany" value='<%=nameCompany%>'>
						<input type="hidden" id="idCompany" name="idCompany" value='<%=idCompany%>'>
						<div class="mb-3">
							<label for="" class="form-label">Tipo de uso</label>
							<input autocomplete="off" type="text" id="show" disabled class="form-control" name="usedFor">
						</div>
						<div class="form-check mb-3">
							<input class="form-check-input" type="checkbox" id="agreeCheckbox">
							<label class="form-check-label" for="agreeCheckbox">Estoy de acuerdo con modificar el siguiente campo</label>
	...
	<div class="modal fade" id="modalFabricante" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- Formulario -->
					<form method="post" action="Controller/Process/editdevice.jsp?deviceType=server&formtype=manufacturer" id="myForm1">
						<input type="hidden" id="idDevice" name="idDevice" value='<%=idDevice%>'>
						<input type="hidden" id="nameCompany" name="nameCompany" value='<%=nameCompany%>'>
						<input type="hidden" id="idCompany" name="idCompany" value='<%=idCompany%>'>
						<div class="mb-3">
							<label for="" class="form-label">Fabricante</label>
							<input autocomplete="off" type="text" id="show" disabled class="form-control" name="manufacturer">
						</div>
						<div class="form-check mb-3">
							<input class="form-check-input" type="checkbox" id="agreeCheckbox">
							<label class="form-check-label" for="agreeCheckbox">Estoy de acuerdo con modificar el siguiente campo</label>
	...
	<div class="modal fade" id="modalModelo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- Formulario -->
					<form method="post" action="Controller/Process/editdevice.jsp?deviceType=server&formtype=model" id="myForm1">
						<input type="hidden" id="idDevice" name="idDevice" value='<%=idDevice%>'>
						<input type="hidden" id="nameCompany" name="nameCompany" value='<%=nameCompany%>'>
						<input type="hidden" id="idCompany" name="idCompany" value='<%=idCompany%>'>
						<div class="mb-3">
							<label for="" class="form-label">Modelo</label>
							<input autocomplete="off" type="text" id="show" disabled  class="form-control" name="model">
						</div>
						<div class="form-check mb-3">
							<input class="form-check-input" type="checkbox" id="agreeCheckbox">
							<label class="form-check-label" for="agreeCheckbox">Estoy de acuerdo con modificar el siguiente campo</label>
	...
	<div class="modal fade" id="modalSerial" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- Formulario -->
					<form method="post" action="Controller/Process/editdevice.jsp?deviceType=server&formtype=serial" id="myForm1">
						<input type="hidden" id="idDevice" name="idDevice" value='<%=idDevice%>'>
						<input type="hidden" id="nameCompany" name="nameCompany" value='<%=nameCompany%>'>
						<input type="hidden" id="idCompany" name="idCompany" value='<%=idCompany%>'>
						<div class="mb-3">
							<label for="" class="form-label">Serial</label>
							<input autocomplete="off" type="text" id="show" disabled  class="form-control" name="serial">
						</div>
						<div class="form-check mb-3">
							<input class="form-check-input" type="checkbox" id="agreeCheckbox">
							<label class="form-check-label" for="agreeCheckbox">Estoy de acuerdo con modificar el siguiente campo</label>
	...
	<div class="modal fade" id="modalSO" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- Formulario -->
					<form method="post" action="Controller/Process/editdevice.jsp?deviceType=server&formtype=so" id="myForm1">
						<input type="hidden" id="idDevice" name="idDevice" value='<%=idDevice%>'>
						<input type="hidden" id="nameCompany" name="nameCompany" value='<%=nameCompany%>'>
						<input type="hidden" id="idCompany" name="idCompany" value='<%=idCompany%>'>
						<div class="mb-3">
							<label for="" class="form-label">Sistema Operativo</label>
							<input autocomplete="off" type="text" id="show" disabled class="form-control" name="so">
						</div>
						<div class="form-check mb-3">
							<input class="form-check-input" type="checkbox" id="agreeCheckbox">
							<label class="form-check-label" for="agreeCheckbox">Estoy de acuerdo con modificar el siguiente campo</label>
	...
	<div class="modal fade" id="modalMac" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- Formulario -->
					<form method="post" action="Controller/Process/editdevice.jsp?deviceType=server&formtype=macAddress" id="myForm1">
						<input type="hidden" id="idDevice" name="idDevice" value='<%=idDevice%>'>
						<input type="hidden" id="nameCompany" name="nameCompany" value='<%=nameCompany%>'>
						<input type="hidden" id="idCompany" name="idCompany" value='<%=idCompany%>'>
						<div class="mb-3">
	...
	<div class="modal fade" id="modalRam" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- Formulario -->
					<form method="post" action="Controller/Process/editdevice.jsp?deviceType=server&formtype=ram" id="myForm1">
						<input type="hidden" id="idDevice" name="idDevice" value='<%=idDevice%>'>
						<input type="hidden" id="nameCompany" name="nameCompany" value='<%=nameCompany%>'>
						<input type="hidden" id="idCompany" name="idCompany" value='<%=idCompany%>'>
						<div class="mb-3">
							<label for="" class="form-label">RAM</label>
							<input autocomplete="off" type="number" id="show" disabled  class="form-control" name="ram">
						</div>
						<div class="form-check mb-3">
							<input class="form-check-input" type="checkbox" id="agreeCheckbox">
							<label class="form-check-label" for="agreeCheckbox">Estoy de acuerdo con modificar el siguiente campo</label>
	...
	<div class="modal fade" id="modalAlm" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- Formulario -->
					<form method="post" action="Controller/Process/editdevice.jsp?deviceType=server&formtype=storage" id="myForm1">
						<input type="hidden" id="idDevice" name="idDevice" value='<%=idDevice%>'>
						<input type="hidden" id="nameCompany" name="nameCompany" value='<%=nameCompany%>'>
						<input type="hidden" id="idCompany" name="idCompany" value='<%=idCompany%>'>
						<div class="mb-3">
							<label for="" class="form-label">Almacenamiento</label>
							<input autocomplete="off" type="number" id="show" disabled  class="form-control" name="storage">
						</div>
						<div class="form-check mb-3">
							<input class="form-check-input" type="checkbox" id="agreeCheckbox">
							<label class="form-check-label" for="agreeCheckbox">Estoy de acuerdo con modificar el siguiente campo</label>
	...
	<div class="modal fade" id="modalTipAlm" tabindex="-1" aria-labelledby="exampleModalLabel"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- Formulario -->
					<form method="post" action="Controller/Process/editdevice.jsp?deviceType=server&formtype=typeStorage" id="myForm1">
						<input type="hidden" id="idDevice" name="idDevice" value='<%=idDevice%>'>
						<input type="hidden" id="nameCompany" name="nameCompany" value='<%=nameCompany%>'>
						<input type="hidden" id="idCompany" name="idCompany" value='<%=idCompany%>'>
						<div class="mb-3">
	...
	<div class="modal fade" id="modalObs" tabindex="-1" aria-labelledby="exampleModalLabel"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- Formulario -->
					<form method="post" action="Controller/Process/editdevice.jsp?deviceType=server&formtype=observations" id="myForm1">
						<input type="hidden" id="idDevice" name="idDevice" value='<%=idDevice%>'>
						<input type="hidden" id="nameCompany" name="nameCompany" value='<%=nameCompany%>'>
						<input type="hidden" id="idCompany" name="idCompany" value='<%=idCompany%>'>
						<div class="mb-3">
